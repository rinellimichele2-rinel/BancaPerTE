...
export default function BonificoScreen() {
  ...
  const validateStep2 = () => {
    ...
    if (!/^[A-Z]{2}[0-9A-Z]+$/.test(ibanClean)) {
      Alert.alert(
        "Errore",
        "L'IBAN deve iniziare con 2 lettere seguite da caratteri alfanumerici",
      );
      return false;
    }
    return true;
    ...
    >
      ...
      <View style={styles.senderCard}>
        ...
        <Text style={styles.senderInfo}>
          Conto - {accountNumber} - {fullName.toUpperCase()}
        </Text>
        <Text style={styles.balanceInfo}>
          Saldo disponibile (Attivo): {formatItalianNumber(activeBalance)} EUR
        </Text>
      </View>
      ...
      <View style={styles.checkboxRow}>
        ...
        <Text style={styles.checkboxLabel}>
          Sto effettuando un bonifico per conto di un’altra persona
        </Text>
      </View>
      ...
      <Text style={styles.helperText}>
        Min: 3 Max: 70 caratteri. Ammessi caratteri alfanumerici e i caratteri
        speciali ,.{"'"}()+:?/-{'"'}&lt;
      </Text>
    </ScrollView>
  );
  ...
  const renderStep2 = () => (
    ...
    >
      ...
      <Text style={styles.helperText}>
        Numero variabile di caratteri alfanumerici. I primi 2 caratteri sono
        lettere e rappresentano la sigla della nazione
      </Text>
    </ScrollView>
  );
  ...
  const renderStep3 = () => (
    ...
    >
      ...
      <View style={styles.optionRow}>
        <View style={styles.optionInfo}>
          ...
          <View style={{ marginLeft: Spacing.md, flex: 1 }}>
            ...
            <Text style={styles.optionDescription}>
              Ti permette di impostare un pagamento automatico con frequenza
              temporale
            </Text>
          </View>
        </View>
      ...
      <View style={styles.costSummary}>
        <View style={styles.costRow}>
          ...
          <Text style={styles.costValue}>
            {formatItalianNumber(parseItalianNumber(importo) || 0)} EUR
          </Text>
        </View>
        <View style={styles.costRow}>
          <Text style={styles.costLabel}>Commissioni</Text>
          <Text style={styles.costValue}>
            {formatItalianNumber(COMMISSION_FEE)} EUR
          </Text>
        </View>
        <View style={[styles.costRow, styles.costRowTotal]}>
          ...
          <Text style={styles.costValueTotal}>
            {formatItalianNumber(
              (parseItalianNumber(importo) || 0) + COMMISSION_FEE,
            )}{" "}
            EUR
          </Text>
        </View>
      ...
      <View style={styles.balanceNote}>
        ...
        <Text
          style={[
            styles.balanceNoteValue,
            parseItalianNumber(importo) + COMMISSION_FEE > activeBalance &&
              styles.balanceNoteValueError,
          ]}
        >
      ...
      parseItalianNumber(importo) > 0 ? (
        <View style={styles.insufficientFundsWarning}>
          ...
          <Text style={styles.insufficientFundsText}>
            Saldo insufficiente per questa operazione
          </Text>
        </View>
      ) : null}
    </ScrollView>
        ...
        <View style={styles.receiptCard}>
          ...
          <View style={styles.receiptRow}>
            ...
            <Text style={styles.receiptValue}>
              Bonifico - {receiptData.destinatario}
            </Text>
          </View>
          <View style={styles.receiptRow}>
            <Text style={styles.receiptLabel}>Importo</Text>
            <Text style={styles.receiptValue}>
              {formatItalianNumber(receiptData.amount)} EUR
            </Text>
          </View>
          <View style={styles.receiptRow}>
            <Text style={styles.receiptLabel}>Stato</Text>
            <Text style={[styles.receiptValue, { color: BankColors.success }]}>
              Eseguito
            </Text>
          </View>
          <View style={styles.receiptRow}>
            ...
            <Text style={styles.receiptValue}>
              Conto {receiptData.accountNumber}
            </Text>
          </View>
          <View style={styles.receiptRow}>
          ...
          <View style={styles.receiptRow}>
            ...
            <Text style={styles.receiptValue}>
              {formatItalianNumber(receiptData.amount + COMMISSION_FEE)} EUR
            </Text>
          </View>
        </View>
      ) : null}
  ...
  if (isSuccess) {
    return <View style={styles.container}>{renderSuccess()}</View>;
  }
          ...
          {isProcessing ? (
            ...
            <Text
              style={[
                ...
                isButtonEnabled() && styles.continueButtonTextActive,
              ]}
            >
              Continua
            </Text>
